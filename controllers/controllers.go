...
import (
	...
	generate "github.com/Mdromi/go-ecom-yt.git/tokens"
...
// VerifyPassword compares the user's password with the given password
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if count > 0 {
			c.JSON(http.StatusBadRequest, gin.H{"error": "this phone no. is already exists"})
			return
		}
...
// ProductViewerAdmin adds a product to the database as an admin
...
// SearchProduct fetches all products from the database
...
// SearchProductByQuery searches products by name using a query parameter
