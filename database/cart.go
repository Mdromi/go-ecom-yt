...
// AddProductToCart adds a product to the user's cart in the database
...
// RemoveCartItem removes an item from the user's cart in the database
...
// BuyItemFromCart completes the purchase of items in the user's cart
...
// InstantBuyer handles the instant purchase of a single item
